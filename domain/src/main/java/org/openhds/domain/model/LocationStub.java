...
public class LocationStub {
	...
	private String locationName, insertBy, insertDate, status, collectedBy, locationHierarchy,locationType,provinceName,subDistrictName,
	districtName,sectorName,localityName,communityName,communityCode, mapAreaName,description, buildingNumber, floorNumber, longitude,latitude;
